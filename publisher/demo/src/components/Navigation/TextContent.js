...
const TextContent = ({children}) => (
    <TextSection>
        ...
        <Content>
            If we look at programmatic advertising market, it may seem that it has not changed much over the past
            12 months. There are still those who dominate the market and impose their rules on others. High fees,
            lack of transparency and questionable traffic are still serious problems advertisers have to struggle with.
            In that respect not much has changed, however from our perspective a huge step was made to start positive
            changes in digital advertising, and we are proud that Adshares plays a significant role in this process.
        </Content>
        <Content>
            <strong>2018 — a general overview</strong>
            Adshares started 2018 with a successful Token Generation Event, which was a turning point for our
            blockchain-based advertising ecosystem. It enabled us to accelerate our project significantly, create
            a community around it, grow the team and reach goals we set earlier. 2018 was a year of constant
            development,
            improvement and learning. We have been following the path we chose, and despite difficulties we achieved and
            learned a lot along the way.
        </Content>
        <Content>
            <strong>What we accomplished over the past year</strong>
            A year ago Adshares was still rather a vision than a product that could change the advertising market.
            As we are entering 2019, our ecosystem is almost ready, and no one can say that it is just an idea. At
            this point it’s one of the most active crypto projects worldwide, with an active community and team of
            highly-qualified and motivated programmers. It is also the most advanced blockchain-based project in the
            advertising market. Our ADST token is available for trading on Cryptopia, CoinExchange and Mercatox and
